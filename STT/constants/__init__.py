...
# s3 buckets
DATA_BUCKET_URI: str ="s3://speech-to-text-project-ak/data/"
...
# Data Ingestion related constant. Meaning we have to download the data from a folder in S3 bucket with the dir name data
DATA_DIR_NAME: str = "data"
DOWNLOAD_DIR: str = 'download_data'
ZIP_FILE_NAME: str = "LJSpeech-1.zip"
UNZIPPED_FOLDER_NAME: str = "LJSpeech-1"
...
S3_BUCKET_URI = "s3://speech-to-text-project-ak/model/"
